...
# Setup rate limiting
if config("RATE_LIMIT_ENABLED", default="true").lower() == "true":
...
app.include_router(project_analysis_router, prefix="/api/v1", tags=["project-analysis"])
app.include_router(analysis_v2_router, tags=["enhanced-analysis"])
...
# Data management routes (upload/generate raster data)
app.include_router(data_upload_router, prefix="/api/v1", tags=["data-management"])
