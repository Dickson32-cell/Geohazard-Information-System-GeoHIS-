...
class FloodRiskAnalyzer:
    ...
    # Use centralized classification scheme
    CLASSIFICATION_SCHEME = SUSCEPTIBILITY_5CLASS
    ...
    def compute_flood_susceptibility(
        ...
        if self.weights is None:
            raise ValueError("Failed to calculate flood weights")
        ...
        # Classify susceptibility using centralized classification
        classification = classify_array(susceptibility, self.CLASSIFICATION_SCHEME)
        ...
        stats = {
            ...
            'class_distribution': get_class_distribution(susceptibility, self.CLASSIFICATION_SCHEME)
        }
...
class LandslideRiskAnalyzer:
    ...
    # Use centralized classification scheme for LSI
    CLASSIFICATION_SCHEME = LSI_5CLASS
    ...
    def compute_landslide_susceptibility(
        ...
        if self.fr_analyzer is None:
            raise ValueError("Failed to initialize Frequency Ratio analyzer")
...
class RiskAssessmentEngine:
    ...
    # Use centralized classification scheme for risk
    CLASSIFICATION_SCHEME = RISK_5CLASS
    ...
    def get_risk_level(self, risk_score: float) -> str:
        """Classify risk score into risk level using centralized classification."""
        return classify_value(risk_score, self.CLASSIFICATION_SCHEME)
    ...
    def generate_risk_report(
        ...
        # Count by risk level using centralized scheme
        level_counts = {level: 0 for level in self.CLASSIFICATION_SCHEME.class_names}
...
def run_complete_analysis(
    ...
    # Run flood analysis
    if engine.flood_analyzer is None:
        engine.set_study_area(study_area_bounds)
    
    if engine.flood_analyzer is None or engine.landslide_analyzer is None:
        raise ValueError("Analyzers not properly initialized")
...
class AnalysisEngine:
    ...
    def generate_risk_report(self, risk_data: Dict[str, Any]) -> Dict[str, Any]:
        """Generate a risk assessment report using centralized classification."""
