...
class Settings(BaseSettings):
    ...
    # Geospatial Data Paths (for production deployment)
    elevation_raster_path: str = Field(default="", description="Path to elevation/DEM raster file")
    slope_raster_path: str = Field(default="", description="Path to slope raster file")
    drainage_raster_path: str = Field(default="", description="Path to drainage proximity raster file")
    soil_raster_path: str = Field(default="", description="Path to soil type raster file")
    landuse_raster_path: str = Field(default="", description="Path to land use raster file")
    geology_raster_path: str = Field(default="", description="Path to geology raster file")
    landcover_raster_path: str = Field(default="", description="Path to land cover raster file")
